...
$jlhhalaman = ceil($jumlahdata/$jumlahdataperhalaman);
$halamanAktif = (isset($_GET["halaman"])) ? $_GET["halaman"]: 1;
$awalData = ($jumlahdataperhalaman * $halamanAktif)- $jumlahdataperhalaman;

// var_dump($jumlahdata);s
//$row = $result->fetch_array();
?>

<!DOCTYPE html>
<html lang="en">
<title>Moviefam</title>
<meta charset="UTF-8">
...
<?php if(!isset($_SESSION["tester"])):?>
  <a href="#login" onclick="w3_close()" class="w3-bar-item w3-button w3-center w3-padding-32">LOGIN</a>
...
<?php endwhile; ?>
  ...
  <div class="w3-center w3-padding-32">
    <div class="w3-bar">
      ...
      <a href="?halaman=<?= $halamanAktif - 1; ?>" class="w3-bar-item w3-button"> &lt;-- </a>
    <?php endif; ?>
      <?php for ($i=1; $i <= $jlhhalaman; $i++) :?>
      <?php if($i == $halamanAktif): ?>
      <a href="endpointni.php#res<?= $i; ?>" class="w3-bar-item w3-black w3-button"> <?= $i; ?></a>
      <?php else : ?>
      <a href="?halaman=<?= $i; ?>" class="w3-bar-item w3-button "> <?= $i; ?></a>
      <?php endif ; ?>
      <?php endfor ;?>
